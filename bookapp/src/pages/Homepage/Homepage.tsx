...
const handleClick = () => {
    window.location.href = "https://www.16personalities.com/fa/%D8%A2%D8%B2%D9%85%D9%88%D9%86-%D8%B4%D8%AE%D8%B5%DB%8C%D8%AA";
};
export default function HomePage() {
    ...
    <div className={styles.container}>
        <div className={styles.topSection}>
            ...
            <button onClick={handleClick} className={styles.mbtitest}>تست MBTI</button>
            </div>
    ...
    <div className={styles.content}>
        <h2>BookTalk</h2>
        <h4>
        جایی برای به اشتراک گذاشتن دیدگاه‌های شما درباره کتاب‌ها
        </h4>
        <p>
    ...
    <div className={styles.suggestion}>
        ...
        <p>
        «شازده کوچولو»، اثر آنتوان دو سنت‌اگزوپری، با روایت‌های شاعرانه و نمادین
        خود، به INFJها کمک می‌کند تا به سادگی و زیبایی دنیای پیرامون نگاه کنند و
        ارزش‌های واقعی زندگی را درک نمایند.
        </p>
    </div> 
    <div className={styles.bookcover}>
        <img
